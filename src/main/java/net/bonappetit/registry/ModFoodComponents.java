...
public class ModFoodComponents {
    public static final FoodComponent LEEK = new FoodComponent.Builder().hunger(1).saturationModifier(0.1f).build();
    ...
    public static final FoodComponent CHEESE_CROQUETTES = new FoodComponent.Builder().hunger(3).saturationModifier(0.3f).snack().build();
    public static final FoodComponent CHEESE_SOUP = new FoodComponent.Builder().hunger(5).saturationModifier(0.4f).build();
