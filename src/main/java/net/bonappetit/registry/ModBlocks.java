...
public class ModBlocks 
{
    ...
    static {
        ...
        Blocks.put("LIMESTONE_STAIRS", new SimpleBlock("limestone_stairs", Registry.BLOCK, FabricBlockSettings.of(Material.STONE).breakByTool(FabricToolTags.PICKAXES, 0).requiresTool().strength(1.25f, 5.0f).sounds(BlockSoundGroup.NETHERRACK)));
        Blocks.put("LIMESTONE_WALL", new SimpleBlock("limestone_wall", Registry.BLOCK, FabricBlockSettings.of(Material.STONE).breakByTool(FabricToolTags.PICKAXES, 0).requiresTool().strength(1.25f, 5.0f).sounds(BlockSoundGroup.NETHERRACK)));
        Blocks.put("LIMESTONE_SLAB", new SimpleBlock("limestone_slab", Registry.BLOCK, FabricBlockSettings.of(Material.STONE).breakByTool(FabricToolTags.PICKAXES, 0).requiresTool().strength(1.25f, 5.0f).sounds(BlockSoundGroup.NETHERRACK)));
        ...
        Blocks.put("LIMESTONE_POLISHED_STAIRS", new SimpleBlock("limestone_polished_stairs", Registry.BLOCK, FabricBlockSettings.of(Material.STONE).breakByTool(FabricToolTags.PICKAXES, 0).requiresTool().strength(1.25f, 5.0f).sounds(BlockSoundGroup.NETHERRACK)));
        Blocks.put("LIMESTONE_POLISHED_SLAB", new SimpleBlock("limestone_polished_slab", Registry.BLOCK, FabricBlockSettings.of(Material.STONE).breakByTool(FabricToolTags.PICKAXES, 0).requiresTool().strength(1.25f, 5.0f).sounds(BlockSoundGroup.NETHERRACK)));
