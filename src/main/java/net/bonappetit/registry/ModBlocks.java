...
public class ModBlocks {
    ...
    public static final Block LIMESTONE_POLISHED = register("limestone_polished", new Block(FabricBlockSettings.of(Material.STONE).breakByTool(FabricToolTags.PICKAXES, 0).requiresTool().strength(1f, 3f).sounds(BlockSoundGroup.NETHERRACK)));
